...
values
  ...
  (
    ...
    'Apple',
    'Golden Delicious',
    'Golden apple variety for a fuller production block.',
    'Monitor fruit load and keep regular thinning notes.',
    'Yellow dessert apple with reliable storage potential.',
    'Late September',
    'Average scab resistance',
    'United States',
    false
  ),
  (
    ...
    'Apple',
    'Jonagold',
    'Additional apple variety for baseline list and filter coverage.',
    'Needs balanced pruning to avoid excessive vigor.',
    'Large aromatic dessert apple.',
    'October',
    'Moderate resistance',
    'United States',
    false
  ...
  (
    ...
    'Apple',
    'Red Jonaprince',
    'Red apple variety used in the mixed southern plot.',
    'Keep canopy open for fruit color.',
    'Intense red fruit, good for fresh market.',
    'Late September',
    'Average resistance',
    'Netherlands',
    false
  ...
  (
    ...
    'Apple',
    'Pinova',
    'Apple variety used to diversify the mixed plot.',
    'Regular thinning helps keep fruit size even.',
  ...
  (
    ...
    'Pear',
    'Williams',
    'Pear variety for mixed-species baseline examples.',
    'Sensitive to late frost; monitor flowering window.',
    'Classic aromatic pear.',
    'August',
    'Average resistance',
    'United Kingdom',
    false
  ...
  (
    ...
    'Pear',
    'Bosc',
    'Pear variety for additional mixed plot realism.',
    'Keep notes on fruit russeting and harvest timing.',
    'Brown russet pear with firm texture.',
    'September',
    'Moderate resistance',
    'France',
    false
...
values
  ...
  (
    ...
    'fruiting',
    '2025-09-18',
    'Baseline enrichment tree for a fuller northern production row.',
    true,
    true
  ),
  (
  ...
  (
    ...
    '2022-03-22',
    'M9',
    'Golden Delicious pollinator group',
    'good',
    'Healthy',
    'fruiting',
    '2025-09-25',
    'Baseline enrichment tree for Golden Delicious coverage.',
    true,
    true
  ),
  (
  ...
  (
    ...
    'Golden Delicious pollinator group',
    'warning',
    'Light nutrient stress monitored in spring',
    'fruiting',
    '2025-09-25',
    'Baseline enrichment warning-state example for Golden Delicious.',
    true,
    true
  ),
  (
    ...
    '2019-03-20',
    'Quince A',
    'Mixed pear section B',
    'good',
    'Healthy',
    'fruiting',
    '2025-09-28',
    'Baseline enrichment tree for mixed southern plot.',
    true,
    true
  ),
  (
  ...
  (
    ...
    '2020-03-24',
    'M9',
    'Mixed apple section C',
    'good',
    'Healthy',
    'fruiting',
    '2025-10-02',
    'Baseline enrichment tree for mixed section C.',
    true,
    true
  ),
  (
  ...
  (
    ...
    'Mixed apple section C',
    'warning',
    'Needs follow-up leaf inspection',
    'fruiting',
    '2025-10-02',
    'Baseline enrichment warning-state example for mixed section C.',
    true,
    true
  ),
  (
  ...
  (
    ...
    '2020-03-12',
    'M9',
    'Upper terrace Idared group',
    'good',
    'Healthy',
    'fruiting',
    '2025-10-03',
    'Baseline enrichment tree for the secondary orchard.',
    true,
    true
  ),
  (
  ...
  (
    ...
    'Upper terrace Idared group',
    'warning',
    'Minor limb damage after wind',
    'fruiting',
    '2025-10-03',
    'Baseline enrichment warning-state example for the secondary orchard.',
    true,
    true
  ),
  (
    ...
    '2018-03-05',
    'Alycza',
    'Lower terrace plum group',
    'good',
    'Healthy',
    'fruiting',
    '2025-09-26',
    'Baseline enrichment tree for the lower terrace.',
    false,
    true
  ),
  (
