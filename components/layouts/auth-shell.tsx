  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-6xl items-center px-4 py-10 sm:px-6">
      <div className="grid w-full gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <section className="hidden rounded-[2rem] bg-[#1f3a28] p-10 text-white shadow-[0_30px_90px_rgba(31,58,40,0.24)] lg:flex lg:flex-col lg:justify-between">
          <div className="space-y-6">
            <p className="text-sm uppercase tracking-[0.3em] text-[#d7c5a1]">
              OrchardLog / Sadownik+
            </p>
            <h1 className="max-w-xl text-4xl font-semibold leading-tight">
              Jeden aktywny sad, uporzadkowana praca w terenie i stabilna baza pod dalszy rozwoj aplikacji.
            </h1>
            <p className="max-w-lg text-base leading-7 text-[#d7e3d8]">
              Zacznij od bezpiecznego logowania, utworz pierwszy sad i buduj na nim dzialki, odmiany, drzewa oraz kolejne moduly operacyjne.
            </p>
          </div>
